...
ll n, maxw;
vector<vl> dp;
ll knapsack(ll idx, ll weight, vl &w, vl &v)
{

    if (idx == n || weight - w[idx] < 0)
        return 0;
    ll take = v[idx] + knapsack(idx + 1, weight - w[idx], w, v);
    ll nottake = knapsack(idx + 1, weight, w, v);
